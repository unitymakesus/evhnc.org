...
Color.prototype.toString = function(remove_alpha) {
  ...
  $('.progression-color-control').each(function() {
	var $control = $(this),
	...
	$('<div class="progression-alpha-container"><div class="slider-alpha"></div><div class="transparency"></div></div>').appendTo($control.parents('.wp-picker-container'));
